          ...
          <div className="sidebar-logo">
            <span className="logo-brand" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <svg width="32" height="32" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="36" height="36" rx="12" fill="url(#cute-tementrip-reg-grad)"/>
                ...
                <defs>
                  <linearGradient id="cute-tementrip-reg-grad" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
              ...
              <span className="logo-text" style={{ color: '#0284c7', fontWeight: 800, fontSize: '20px', letterSpacing: '-0.5px' }}>Temen<span style={{ color: '#00c9a7' }}>Trip</span><span style={{ color: '#ff6b81', fontSize: '16px' }}>✨</span></span>
              <span className="logo-badge">Partner</span>
            </span>
          </div>
