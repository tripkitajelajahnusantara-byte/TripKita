...
func NewContainer(db *gorm.DB, cfg *config.Config) *Container {
	...
	return &Container{
		...
		XenditService:  xenditService,
		AuthService:    NewAuthService(db, providerRepo, cfg, emailService),
		AdminService:   NewAdminService(db, providerRepo),
		...
		DashService:    NewDashboardService(packageRepo, bookingRepo, providerRepo),
