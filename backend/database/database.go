...
func EnsureAllTestProvidersAndSeats() {
	...
	packagesToEnsure := []models.Package{
		...
		{Name: "Private Trip Bromo Sunrise & Savana", Destination: "Probolinggo, Jawa Timur", Category: "Gunung", TripType: "Private Trip", Price: 1250000, QuotaMin: 1, QuotaMax: 10, StartDate: todayStr, EndDate: todayStr, Schedule: "Fleksibel (Pilihan Customer)", Status: "Aktif", Rating: 4.9, Image: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&w=1200&q=80"},
		{Name: "Private Trip Wisata Raja Ampat 4D3N", Destination: "Papua Barat", Category: "Diving & Snorkeling", TripType: "Private Trip", Price: 3850000, QuotaMin: 1, QuotaMax: 8, StartDate: todayStr, EndDate: todayStr, Schedule: "Fleksibel (Pilihan Customer)", Status: "Aktif", Rating: 5.0, Image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=1200&q=80"},
